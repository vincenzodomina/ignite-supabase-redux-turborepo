...
export default function DemoPodcastListScreen(_props: any) {
  const episodeStore: any = undefined;
  ...
  return (
    ...
    >
      <ListView<any>
        ...
        extraData={(episodeStore?.favorites?.length || 0) + (episodeStore?.episodes?.length || 0)}
